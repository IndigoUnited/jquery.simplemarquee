!(function (root, factory) {
    ...
    SimpleMarquee.prototype.update = function (instant) {
        this._reset();
        this._setup();
    ...
    SimpleMarquee.prototype.pause = function () {
        ...
        if (!this._paused && this._wrappers) {
            this._pause();
    ...
    SimpleMarquee.prototype._reset = function () {
       ...
       // Reset styles
        ...
        if (this._animationEl) {
            contents = this._animationEl.contents();
    ...
    SimpleMarquee.prototype._setup = function () {
        ...
        this._animationEl = this._wrappers.eq(0);
    ...
    SimpleMarquee.prototype._setupAnimation = function () {
        ...
        prefixedEvent(this._animationEl, 'AnimationIteration', this._onCycle);
    };

    SimpleMarquee.prototype._pause = function () {
        this._wrappers && this._wrappers.css('animation-play-state', 'paused');
    };

    SimpleMarquee.prototype._resume = function () {
        this._wrappers && this._wrappers.css('animation-play-state', '');
    };
